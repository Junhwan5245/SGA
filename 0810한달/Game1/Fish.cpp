...
Fish::Fish()
{
    ...
    dead = new ObImage(L"Fishdead.png");
}
...
void Fish::Init(Vector2 spawn)
{
    ...
    dead->maxFrame.x = 3;
    dead->scale.x = dead->imageSize.x / dead->maxFrame.x * 3.0f;
    dead->scale.y = dead->imageSize.y * 3.0f;

    dead->ChangeAnim(ANIMSTATE::ONCE, 0.1f);
