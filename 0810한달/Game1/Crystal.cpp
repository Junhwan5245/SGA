...
Crystal::Crystal()
{
    ...
    dead = new ObImage(L"Crystaldead.png");
}
...
void Crystal::Init(Vector2 spawn)
{
    ...
    dead->maxFrame.x = 3;
    dead->scale.x = dead->imageSize.x / dead->maxFrame.x * 2.5f;
    dead->scale.y = dead->imageSize.y * 2.5f;

    dead->ChangeAnim(ANIMSTATE::ONCE, 0.3f);
